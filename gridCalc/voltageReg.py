...
# HW5
# Problem 1:
# Consider the 19-20 transmission line in Trudnowski et al. 
# Develop short, medium and long transmission line ABCD models for this line. 
# Compare the VR and efficiency calculations that derive from these models, and comment on the differences.
...
# impedance and admittance in per unit
Z = z_pu
Y = y_pu
