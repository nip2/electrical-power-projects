...
# HW 4
# Problem 1
#A 500 kV, 150 MVA three-phase transmission line will use ACSR conductors. 
# The line is 95 miles long, and the conductors are arranged in an equilateral triangle formation with sides of 8 ft. Nominal operating temperature is 50 °C.2
...
# d. Calculate the ABCD matrix coefficients appropriate for the given length.
# Demonstrate the capabilities of your script by showing results for three ACRS conductors appropriate for this particular transmission line.
